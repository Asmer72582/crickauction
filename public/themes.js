...
const THEMES = {
  classic: {
    ...
    fonts: {
      heading: '"myFont", "Rajdhani", sans-serif',
      body: '"myFont", "Rajdhani", sans-serif',
    },
    layout: 'summary-card',
    animations: {
  ...
  ipl: {
    ...
    colors: {
      ...
      teamA: ['#4964A1', '#002153'],
      teamB: ['#C8102E', '#8B0000'],
      background: 'linear-gradient(135deg, #002153 0%, #4964A1 50%, #002153 100%)',
      ...
      chaseBg: 'rgba(73, 100, 161, 0.5)',
      resultBg: 'linear-gradient(90deg, #002153, #4964A1)',
